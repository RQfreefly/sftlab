...
- 文件编码统一为 UTF-8（Windows 下读取文档建议显式指定 UTF-8）。
- Python 命名遵循：
  - 文件/函数/变量：`snake_case`
  - 类名：`PascalCase`
- 新增依赖请同步更新根目录 `requirements.txt`。
- 提交信息使用 Conventional Commits，例如：`feat: add xxx`

## 文档索引

- 需求文档：[docs/需求文档/01_SFT工具集初步需求文档.md](docs/需求文档/01_SFT工具集初步需求文档.md)
- 开发文档：[docs/开发文档/01_SFT工具集逐步开发文档.md](docs/开发文档/01_SFT工具集逐步开发文档.md)
